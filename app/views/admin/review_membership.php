...
<div class="mb-4">
    <a href="index.php?r=admin/memberships" class="btn btn-outline-secondary btn-sm mb-2"><i class="bi bi-arrow-left"></i> Back</a>
...
<div class="row g-4">
    ...
    <div class="col-lg-6">
        ...
        <div class="card">
            <div class="card-header px-3 py-2"><h2 class="h6 mb-0">Admin Actions</h2></div>
            <div class="card-body">
                <form method="post" class="vstack gap-3">
                    <div>
                        <label class="form-label" for="trainer_id">Assign Fitness Trainer (from available employees)</label>
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        <button type="submit" name="action" value="approve" class="btn btn-success btn-sm"><i class="bi bi-check-circle"></i> Approve & Generate Code</button>
                        <button type="submit" name="action" value="resubmit" class="btn btn-warning btn-sm text-dark"><i class="bi bi-arrow-repeat"></i> Request Resubmission</button>
        ...
        <div class="card">
            <div class="card-body text-center py-4">
                ...
                <?php elseif ($app['status'] === 'verified'): ?>
                    ...
                    <p class="mt-2 mb-0">Application <strong>verified</strong> — awaiting payment.</p>
                <?php else: ?>
