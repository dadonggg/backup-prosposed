    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table table-hover mb-0">
                <thead><tr><th>ID</th><th>Applicant</th><th>Name</th><th>Phone</th><th>Plan</th><th>Amount</th><th>Status</th><th>Date</th><th>Action</th></tr></thead>
                <tbody>
                    <?php if (empty($apps)): ?>
                    ...
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="index.php?r=gymowner/reviewmembership&id=<?= $a['id'] ?>" class="btn btn-outline-primary btn-sm"><i class="bi bi-eye"></i> Review</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
